...
static const struct of_device_id accel_of_match[] = {
	{.compatible = "mediatek,kxtj2_gsensor"},
	{},
};
#endif
...
static int kxtj2_1009_init_client(struct i2c_client *client, int reset_cali)
{
	...
	int res = 0;
	GSE_FUN();
printk("kxtj2_1009_init_client i2c adr=0x%x \n",client->addr);
...
static int kxtj2_1009_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	//client->addr=obj->hw->i2c_addr[0];//yixuhong 20160509 add,get i2c address from dts

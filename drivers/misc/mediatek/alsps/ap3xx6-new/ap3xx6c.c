...
static struct alsps_hw ap3xx6_cust = {
	.i2c_num    = 2,
	.polling_mode_ps = 1,
	.polling_mode_als = 1,
	...
	.i2c_addr   = {0x1e},
	.als_level       = {0, 1, 4, 7, 15, 15, 100, 1000, 2000, 3000, 6000, 10000, 14000, 18000, 20000},/* als_code */
...
static struct alsps_hw *hw = &ap3xx6_cust;
struct platform_device *alspsPltFmDev;
/* For alsp driver get cust info */
struct alsps_hw *ap3xx6_get_cust_alsps(void)
{
	return &ap3xx6_cust;
}
/*----------------------------------------------------------------------------*/
...
static int ap3xx6_init_client(struct i2c_client *client)
{
	...
	ap3xx6_set_PSTtime(client, 0x08);
	ap3xx6_set_PSgain(client, 0x01);//0x00 //modified by xiehaifei for ps cali
...
static int ap3xx6_remove(void)
{
	struct alsps_hw *hw = ap3xx6_get_cust_alsps();
	APS_FUN();
	ap3xx6_power(hw, 0);

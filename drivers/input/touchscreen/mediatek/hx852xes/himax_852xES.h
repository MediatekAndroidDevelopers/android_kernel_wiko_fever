...
static int gest_key_pt_y[3];
  ...
  #define KEY_DUBCLICK KEY_P //0x21f
	#define KEY_CUST_01  KEY_UP //0x21d //Up
	#define KEY_CUST_02  KEY_DOWN //0x21e //Down
	#define KEY_CUST_03  KEY_LEFT //0x21c //Left
	#define KEY_CUST_04  KEY_RIGHT //T0x21b //Right
	#define KEY_CUST_05  KEY_C    //0x225 //C
	#define KEY_CUST_06  KEY_Z    //0x226 //Z
	#define KEY_CUST_07  KEY_M    //0x222 //m
	#define KEY_CUST_08  KEY_O  //0x220 //O
	#define KEY_CUST_09  KEY_S   //0x227 //S
	#define KEY_CUST_10  KEY_V    //0x228 //V
	#define KEY_CUST_11  KEY_W     //0x223 //W
	#define KEY_CUST_12  KEY_E     //0x221 //e

...
#define IIC_PORT						1				//Based on the I2C index you choose for TPM
#define TPD_HAVE_BUTTON									// if have virtual key,need define the MACRO
#define TPD_BUTTON_HEIGH				(40)  			//100
#if defined(LYCONFIG_AUTO_SCREEN_SIZE_HD)
	#define TPD_KEY_COUNT   				3
	#define TPD_KEYS        				{KEY_MENU, KEY_HOMEPAGE, KEY_BACK }
	#define TPD_KEYS_DIM					{{200,1500,20,TPD_BUTTON_HEIGH},{400,1500,20,TPD_BUTTON_HEIGH},{600,1500,20,TPD_BUTTON_HEIGH}}
#elif defined(LYCONFIG_COMB_CUST_PROJECT_NAME_Z300_DD)
	#define TPD_KEY_COUNT					3
	#define TPD_KEYS						{KEY_MENU, KEY_HOMEPAGE, KEY_BACK }
	#define TPD_KEYS_DIM					{{100,1000,20,TPD_BUTTON_HEIGH}, {250,1000,20,TPD_BUTTON_HEIGH}, {400,1000,20,TPD_BUTTON_HEIGH}}
#else
	#define TPD_KEY_COUNT					3
	#define TPD_KEYS						{KEY_MENU, KEY_HOMEPAGE, KEY_BACK }
